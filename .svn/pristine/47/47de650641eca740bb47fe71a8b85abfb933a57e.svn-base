...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    private static String PATH = UriConstant.APP_ROOT_PATH + UriConstant.LOG_DIR;
...
//        autoClear(Constant.CRASH_LOG_DELETE_TIME);
    }
    ...
    /*public void autoClear(final int autoClearDay) {
        FileUtil.delete(PATH, new FilenameFilter() {
