...
public class InitActivity extends AppCompatActivity {
    ...
    public void initView() {
        ...
        firstStep = (LinearLayout) findViewById(R.id.init_step_1);
        secondStep = (LinearLayout) findViewById(R.id.init_step_2);
...
//        testVideo.setAdvsType(Constant.AD_TYPE_INIT);
